...
#We create an AES cipher object in EAX mode.EAX mode (Encrypt-then-MAC) is used because it ensures both confidentiality and integrity of the encrypted data.
